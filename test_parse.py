...
async def parse():
    ...
    pg = await b.new_page(user_agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36")
    ...
    for pn in range(1, 6):
        ...
        try:
            ...
            print(f"  Total so far: {len(results)}", flush=True)
